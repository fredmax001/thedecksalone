...
export default function MixHub() {
  ...
  return (
    <div className="min-h-[100dvh] bg-bg-page pb-32">
          ...
          <div className="flex items-center gap-2">
            {featuredMix && (
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gold text-black font-bold text-xs uppercase tracking-wider hover:brightness-110 active:scale-95 transition-all shadow-md shadow-gold/20"
              >
                <Play className="w-3.5 h-3.5 fill-current" />
                <span className="hidden sm:inline">Play Spotlight</span>
              </button>
            )}
            <button
      ...
      <section className="sticky top-14 sm:top-16 lg:top-20 z-20 bg-black/95 backdrop-blur-xl border-b border-dark-gray mb-8 py-3">
