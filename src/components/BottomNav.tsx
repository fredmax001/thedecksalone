          ...
          >
            ...
            <div className="relative z-10">
              <Avatar className={`h-5 w-5 transition-all duration-200 ${
                isAccountActive ? 'border-2 border-gold shadow-[0_0_12px_rgba(244,224,89,0.6)] scale-110' : 'border border-gold/40'
              }`}>
            ...
            <span className={`text-[9px] font-bold z-10 uppercase tracking-tight transition-colors ${isAccountActive ? 'text-gold font-extrabold' : 'text-text-muted'}`}>
              Me
            </span>
          </Link>
        ) : (
